...
## 2026-09-01 — Применён изолированный production foundation

**Решение:** создать production foundation в отдельном S3 state object, изолированном от legacy state `statuspage-dev`.
